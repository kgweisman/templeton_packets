...
This is a document describing how we clean up and "wrangle" data from Packets 1-3.
...
```{r}
write.csv(d_all, "./packets_data.csv")
write.csv(question_key, "./question_key_R.csv")
```
