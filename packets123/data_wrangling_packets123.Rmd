...
This is a document describing how we clean up and "wrangle" data from Packets 1-3. (Last updated 2018-04-07.)
...
# center the scale 
d_sen2 <- d_sen2 %>%
  mutate_at(vars("sen2_01_num", "sen2_02_num", "sen2_03_num", "sen2_04_num",
                 "sen2_05_num", "sen2_06_num", "sen2_07_num", "sen2_08_num",
                 "sen2_09_num", "sen2_10_num", "sen2_11_num", "sen2_12_num",
                 "sen2_13_num", "sen2_14_num", "sen2_15_num", "sen2_16_num",
                 "sen2_17_num", "sen2_18_num", "sen2_19_num", "sen2_20_num",
                 "sen2_21_num"),
            funs(. - 2))
...
It came to my attention that there was at least one participant (#40082) who had data for two versions of the same packet (Packet 1). Let's check to see if there's anyone else like that.
...
Looks like it was just that person. We'll exclude both of their versions for now (since they seem to be quite different from each other...)

```{r}
d_all <- d_all %>%
  filter(subj != dup_subj7$subj)
```
